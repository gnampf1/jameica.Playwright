 ...
 * mitgelieferte playwright-Version geladen wurde und nicht eine abweichende Kopie aus einem
...
public class Plugin extends AbstractPlugin
{
	...
	public void init()
	{
		checkLibrary(com.microsoft.playwright.Playwright.class, "playwright");
	}
